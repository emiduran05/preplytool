...
//       const data = await res.json();
//       return (
//         data?.data?.meanings?.[0]?.senses?.[0]?.description ||
//         "Sin definición"
//       );
//     } catch {
//       return "Error al obtener definición";
...
//     await fetch(
//       "https://preplytool-2tgl.vercel.app/api/student-lessons/notes",
//       {
//         method: "POST",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify({
...
//   const toggleCompleted = async (checked) => {
//     await fetch(
//       "https://preplytool-2tgl.vercel.app/api/student-lessons/update",
//       {
//         method: "POST",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify({
...
//     document.querySelectorAll(".student-input").forEach((input) => {
//       const ok =
//         input.value.trim().toLowerCase() === input.dataset.answer;
//       input.style.border = ok ? "2px solid green" : "2px solid red";
//       input.style.background = ok ? "#e8f5e9" : "#ffebee";
//     });
//   };
...
//                           <td>{v.palabra}</td>
//                           <td>
//                             {definiciones[v.palabra] || "Cargando..."}
//                           </td>
//                           <td>
//                             {ejemplos[v.palabra] || "Cargando..."}
//                           </td>
//                         </tr>
//                       ))}
//                     </tbody>
...
//                   type="checkbox"
//                   checked={
//                     completedLessons[leccionId]?.completed || false
//                   }
//                   onChange={(e) =>
